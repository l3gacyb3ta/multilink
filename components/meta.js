...
const Meta = ({
  title = '@lilvibeyloser', // page title
  name = '@lilvibeyloser multilink', // site name
  description = '@lilvibeyloser social media and more!', // page description
  image = '', // social card image URL
  url = 'https://www.lilvibeyloser.tk/',
  children,
}) => (
  <Head>
